    ...
    <div class="row">
      ...
      <div class="col-9">
        <div class="row mb-3">
          <div class="col-4">
            <div class="stats-card ${
              hpStats.base_stat <= 50 ? 'bad-stat' : 'good-stat'
            }">
          ...
          <div class="col-4">
            <div class="stats-card ${
              attackStats.base_stat <= 50 ? 'bad-stat' : 'good-stat'
            }">
          ...
          <div class="col-4">
            <div class="stats-card ${
              defenseStat.base_stat <= 50 ? 'bad-stat' : 'good-stat'
            }">
        ...
        <div class="row">
          <div class="col-4">
            <div class="stats-card ${
              specialAttStats.base_stat <= 50 ? 'bad-stat' : 'good-stat'
            }">
          ...
          <div class="col-4">
            <div class="stats-card ${
              specialDefStats.base_stat <= 50 ? 'bad-stat' : 'good-stat'
            }">
          ...
          <div class="col-4">
            <div class="stats-card ${
              speedStats.base_stat <= 50 ? 'bad-stat' : 'good-stat'
            }">
